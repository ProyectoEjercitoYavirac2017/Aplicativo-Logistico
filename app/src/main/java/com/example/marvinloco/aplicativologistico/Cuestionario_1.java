        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (c1.isChecked()==true) {
                    Toast.makeText(Cuestionario_1.this, "ACTIVADO SI", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Cuestionario_1.this, "DESACTIVADO SI", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        c2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (c2.isChecked()==true) {
                    Toast.makeText(Cuestionario_1.this, "ACTIVADO NO", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Cuestionario_1.this, "DESACTIVADO NO", Toast.LENGTH_SHORT).show();
                }
            }
