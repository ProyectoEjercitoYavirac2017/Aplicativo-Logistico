...
public class Question_2 extends AppCompatActivity implements View.OnClickListener {
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (c1.isChecked()==true) {
                    Toast.makeText(Question_2.this, "ACTIVADO SI", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Question_2.this, "DESACTIVADO SI", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        c2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (c2.isChecked()==true) {
                    Toast.makeText(Question_2.this, "ACTIVADO NO", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Question_2.this, "DESACTIVADO NO", Toast.LENGTH_SHORT).show();
                }
            }
